<template>
    <q-table
        ...
        :rows-per-page-options="util.isObject(template.table) && template.table.page?.options ? template.table.page.options : [10, 20, 30]"
        @request="do_request"
        binary-state-sort
    ...
    >
        ...
        <template v-slot:pagination="scope">
            ...
            >
                <template v-if="util.isObject(template.table) && util.isObject(template.table.page) ? (true === template.table.page.count) : false" v-slot:append>
...
export default {
    components: {
        ...
        View: defineAsyncComponent(() => import("src/pages/grid/View")),
        Edit: defineAsyncComponent(() => import("src/pages/grid/Edit")),
    },
