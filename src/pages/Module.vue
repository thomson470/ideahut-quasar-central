    ...
    <q-card>
            ...
            <q-card>
                ...
                <q-card-section horizontal>
                    ...
                    <q-img 
                        v-else
                        class="col-3"
                        :src="uix.multimedia.url(project.icon)"
                        height="200px"
                        fit="fill"
                    >
        ...
        >
            ...
            <div v-else class="row q-pa-sm" style="max-height: 58vh; overflow-y: scroll;">
                <q-card v-for="(module, index) in modules"
                    :key="index" 
                ...
                >
                    ...
                    <q-img 
                        v-else
                        :src="uix.multimedia.url(module.icon)"
                        height="160px"
                        fit="fill"
                    >
                        <template v-slot:error>
...
export default {
    ...
    methods: {
        ...
        on_open_page(module) {
            ...
            let href = url.protocol + "//" + url.hostname + 
            (url.port !== 80 && url.port !== 443 ? (":" + url.port) : "") + 
            util.publicPath() + "/redirect?projectId=" + self.project.projectId + "&moduleId=" + module.moduleId;
